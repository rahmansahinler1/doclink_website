...
const blogData: Blog[] = [
  {
    ...
    introText: "In today's digital landscape, data security isn't just a feature - it's a fundamental necessity. At Doclink, we understand that our users trust us with their valuable documents and sensitive information. That's why security has been at the core of our architecture from day one. When you're working with oclink, whether you're uploading business documents, research papers, or personal files, our security infrastructure ensures that your data stays exactly where it belongs - in your control. Let's take you through our comprehensive security approach and the measures we've implemented to keep your data safe.",
    content: "Every interaction with Doclink begins with secure authentication. We've implemented Google OAuth 2.0 integration alongside our traditional authentication system, providing you with industry-standard security practices. Our session management system uses encrypted cookies and secure tokens, ensuring that your session remains protected throughout your interaction with our platform. We believe in encryption everywhere. That's why we've implemented AES-GCM (Advanced Encryption Standard in Galois/Counter Mode), one of the most secure encryption methods available. Every document you upload is encrypted before storage, with unique encryption keys for each file. This means that even in the unlikely event of unauthorized access, your documents remain unreadable without the proper decryption keys. Also because of our storage architecture every sentence of your documents are encrypted separately. We utilize PostgreSQL for our database, implementing multiple security layers: Encrypted connections for all database transactions, Secure password hashing, Encrypted document contents, Regular security audits and updates, Automated backup systems"
  },
  {
    id: 2,
